      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                @foreach($blog_description as $id)
                ...
                <tr>
                    <th><button class="clo btn0"><a href="{{url('admin/update_blog_description_data')}}/{{$id->id}}">update</a></button></th>
                </tr>
               ...
               @foreach($blog as $key=>$ad)
                 <tbody class="change_visibility_{{$ad->id}}">
                    <tr>
                        ...
                        <td>{{$ad->meta_title}}</td> 
                        <td>{{$ad->meta_description}}</td> 
                        <td>{{$ad->title1}}</td>                                                                     
                        <td>{{$ad->title2}}</td>                                                                     
                        <td>{{$ad->title3}}</td>
                        <td>{{$ad->main_description}}</td>
                       
                        @php $detail_title=json_decode($ad->detail_title);@endphp
                        <td>@if($detail_title!='')@foreach ($detail_title as $dt) <p> {{$dt->title}} </p> @endforeach @endif</td>
                        
                        @php $description=json_decode($ad->description);@endphp
                        <td>@if($description!='')@foreach ($description as $ld) <p> {{$ld->des}} </p> @endforeach @endif</td>

...
<style type="text/css">
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Team Details</span></a>
            </li>
         </ul>
      </div>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                @foreach($team_description as $id)
                ...
                <tr>
                    <th><button class="clo btn0"><a href="{{url('admin/update_team_description_data')}}/{{$id->id}}">update</a></button></th>
                </tr>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            ...
            <div class="btn1-main">
                ...
                <button class="btn1"><a href="{{url('admin/add_team_data')}}/0" style="color:white;">ADD</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
                    ...
                    <tr>
                       ...
                       <td>{{$ad->sub_title}}</td>
                        ...
                        <a class="icon__1" href="{{url('admin/add_social_url_data')}}/{{$ad->id}}"><i class="fas fa-link"></i></a>
                          <a class="icon__1" href="{{url('admin/add_team_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>

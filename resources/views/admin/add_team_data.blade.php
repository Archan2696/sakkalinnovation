 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               ...
               @else
               <a href=""><span>Update Team</span></a>
               @endif
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
           @if($id==0)
            <h4 class="mb-4">Add Team</h4>
          @else
            <h4 class="mb-4">Update Team</h4>
            @endif
         </div>
         <form action="{{url('admin/store_add_team_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="details_inner">
                  <div class="part">
                     <div class="row">
                        ...
                        <div class="col-lg-10 data">
                           <input type="text" placeholder="Enter subtitle" name="sub_title" value="{{$sub_title}}" >

...
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/searchpanes/2.2.0/css/searchPanes.dataTables.min.css" rel="stylesheet">
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Portfolio Details</span></a>
            </li>
         </ul>
      </div>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Portfolio Description</h4>
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                @foreach($portfolio_description as $id)
                ...
                <tr>
                    <th><button class="clo btn0"><a href="{{url('admin/update_portfolio_description_data')}}/{{$id->id}}">update</a></button></th>
                </tr>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            ...
            <div class="btn1-main">
                ...
                <button class="btn1"><a href="{{url('admin/add_portfolio_data')}}/0" style="color:white;">ADD</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
               ...
               <thead>
                ...
                @foreach($portfolio as $key=>$ad)
                    <tr class="change_visibility_{{$ad->id}}">
                        ...
                        <td>{{$ad->link}}</td>
                        <td>
                          <a class="icon__1" href="{{url('admin/add_portfolio_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>

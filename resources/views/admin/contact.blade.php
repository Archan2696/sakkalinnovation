      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                @foreach($contact_description as $id)
                ...
                <tr>
                    <th class="text">{{$id->occupation}}</th>
                </tr>
                ...
                <tr>
                    <th class="text">{{$id->website_link}}</th>
                </tr>
                ...
                <tr>
                    <th><button class="clo btn0"><a href="{{url('admin/update_contact_description_data')}}/{{$id->id}}">update</a></button></th>
                </tr>
